...
const Clients = () => {
  ...
  return (
    <div
      id="clients"
      className="w-full h-auto flex flex-col items-center justify-center lg:px-[80px] px-[20px] lg:py-[80px] py-[60px] gap-[60px] bg-cover bg-center"
      style={{ backgroundImage: `url(${backgroundimage})` }}
    >
      <div
        data-aos="zoom-in"
        data-aos-delay="50"
        className="bg-white rounded-full px-10 py-3 font-semibold flex lg:flex-row flex-col justify-center items-center w-full lg:gap-2 gap-1"
      >
